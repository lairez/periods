...
// We can specify a basis with
// time gm := GaussManinLin(f0, f1 : basis := [1, x^2*y^2, ...]);
...
/* gm is record with the following fields :
    ...
    basis : basis of the cohomology of V(f_0), or the user basis
